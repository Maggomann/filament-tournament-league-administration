...
return [
    ...
    */
    ...
    'rules' => [
        ...
        'game_day_started_at_must_be_smaller_than_end_date' => 'Das Startdatum :value muss vor dem Enddatum liegen.',
        ...
        'game_day_end_must_be_greater_than_started_at_date' => 'Das Enddatum :value muss nach dem Startdatum liegen.',
