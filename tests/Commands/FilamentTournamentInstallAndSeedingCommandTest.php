...
it('can publish all of the filament-tournament-league-administration seeding files and install this', function () {
    $this->artisan('filament-tournament-league-administration:install-and-seeding')
