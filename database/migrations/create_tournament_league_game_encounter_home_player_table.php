    ...
    public function up(): void
    {
        if (! Schema::hasTable('tournament_league_game_encounter_home_player')) {
            Schema::create('tournament_league_game_encounter_home_player', function (Blueprint $table) {
                $table->unsignedBigInteger('game_encounter_id')->nullable()->index('tlge_home_game_encounter_id_index');
                $table->unsignedBigInteger('player_id')->nullable()->index('tlge_home_player_id_index');
            });
        }
    }
